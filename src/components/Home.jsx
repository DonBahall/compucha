...
return (
  ...
  <div>
    ...
    <p className={styles.imgLeft_text}>Embrace the Vibrant Holiday Experience with Kambucha's Unmatched Taste, Energy, and Healthy Lifestyle Benefits!</p>
  </div>
   ...
   <p className={styles.sectionBlue_p1}>Revitalize</p>
    ...
    <div>
        ...
        <div className={styles.spot_sec}>
          <p className={styles.spot_p}>Future<br/> Favorite<br/> Drink</p>
